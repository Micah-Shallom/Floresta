...
- `prune_target_size` - (numeric) Target on-disk size used for pruning, in bytes. Always `0` in Floresta since Utreexo prunes unconditionally and has no disk-size cutoff.
